...
if __name__ == '__main__':
    ...
    train_class_attr_df = pd.read_csv(global_configs.class_attrlabel_path, sep='\t')

    train_pic_class_attr_df = pd.merge(train_pic_class_df, train_class_attr_df, on=['class'])
    print(train_pic_class_attr_df.head())
    print(train_pic_class_attr_df.describe())

    train_pic_class_attr_df.to_csv(global_configs.train_pic_class_attr_path, index=False, sep='\t')